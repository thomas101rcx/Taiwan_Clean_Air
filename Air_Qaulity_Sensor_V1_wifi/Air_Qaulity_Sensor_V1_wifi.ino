...
#define SSID "EDIMAX"  //name of wireless access point to connect to
#define PASS "27032702"  //wifi password
...
float prevVocconavg = 0;
float prevCo2conavg = 0;
...
void setup() {
        ...
        wifiSerial.begin(115200); // For wifi
        SPI.begin();
        Wire.begin();
...
void loop() {
        ...
        if(sinceStartup > 1000 && sinceStartup <4000 && prevTempcavg !=0 && count < 9 ) {
                sendDatatcp(count);
        }
        if (sinceStartup > 24000 && sinceStartup < 27000 && prevTempcavg !=0 && count < 9) {
                sendDatatcp(count);
        }
        if(sinceStartup > 47000 && sinceStartup < 50000 && prevTempcavg !=0 && count < 9) {
                sendDatatcp(count);
        }
...
void sendDatatcp(int dataSelect){
        String dataSend = "";
        String dataField = "&field3=";
        int dataCase;
        dataCase = dataSelect;
        switch(dataCase) {
        case 1:
                dataSend = String(prevVocconavg);
                dataField = "&field7=";
                break;
        case 2:
                dataSend = String(prevPm25avg);
                dataField = "&field3=";
                break;
        case 3:
                dataSend = String(prevPm10avg);
                dataField = "&field5=";
                break;
        case 4:
                dataSend = String(prevPm01avg);
                dataField = "&field6=";
                break;
        case 5:
                dataSend = String(prevCo2conavg);
                dataField = "&field4=";
                break;
        case 6:
                dataSend = String(prevHumidityavg);
                dataField = "&field8=";
                break;
        case 7:
                dataSend = String(prevPressureavg);
                dataField = "&field2=";
                break;
        case 8:
                dataSend = String(prevTempcavg);
                dataField = "&field1=";
                break;
        ...
        // convert to string
        String tempStr = String(dataSend);
